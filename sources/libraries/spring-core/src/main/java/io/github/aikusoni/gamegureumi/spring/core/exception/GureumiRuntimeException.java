...
@Getter
public class GureumiRuntimeException extends RuntimeException implements BaseGureumiException{
     ...
     */
    public GureumiRuntimeException(BaseErrorCode errorCode, String errorAlias, String message) {
        super(message);
     ...
     */
    public GureumiRuntimeException(BaseErrorCode errorCode, String errorAlias, MessageCode messageCode) {
